...
execute at @s if score #version LastLifeconfig matches 2 run execute as @a[team=] if score @s LastLifeLifes matches 2 run title @s title ["",{"score":{"name":"@s","objective":"LastLifeLifes"},"color":"yellow"},{"text":" lives.","color":"green"}]
execute at @s if score #version LastLifeconfig matches 2 run execute as @a[team=] if score @s LastLifeLifes matches 3 run title @s title ["",{"score":{"name":"@s","objective":"LastLifeLifes"},"color":"green"},{"text":" lives.","color":"green"}]
execute at @s if score #version LastLifeconfig matches 2 run execute as @a[team=] if score @s LastLifeLifes matches 4.. run title @s title ["",{"score":{"name":"@s","objective":"LastLifeLifes"},"color":"dark_green"},{"text":" lives.","color":"green"}]
